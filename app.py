...
def main() -> None:
    ...
    with col_title:
        st.markdown(
            f"<h1 style='margin: 12px 0 4px 0; text-align: center;'>{APP_TITLE}</h1>",
            unsafe_allow_html=True,
        )
        st.markdown(
            "<div style='text-align:center; margin: 0 0 14px 0; font-size: 18px; opacity: .9;'>Setor de Contratos</div>",
            unsafe_allow_html=True,
        )
